<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true">
        ...
        <ion-list>
          ...
          >
            ...
            <ion-item-options side="end" @ionSwipe="handleStatus(race)">
              ...
              <ion-item-option color="success" expandable @click="handleStatus(race)">
              ...
              <ion-list>
                ...
                >
                  ...
                  <ion-item-options side="end" @ionSwipe="handleStatus(race)">
                    ...
                    <ion-item-option color="warning" expandable @click="handleStatus(race)">
                      <ion-icon slot="icon-only" :icon="close" color="light" size="large"></ion-icon>
                    </ion-item-option>
                  </ion-item-options>
                </ion-item-sliding>
                <ion-item v-if="completedRaces.length === 0" class="ion-text-center">
      ...
      <InputModal v-model:isOpen="isOpen" v-model:editingId="editingId" :race="race" @submit="handleSubmit" />
    </ion-content>
  </ion-page>
</template>
